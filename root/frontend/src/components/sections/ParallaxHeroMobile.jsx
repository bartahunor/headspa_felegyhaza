...
import bgImage  from "../../assets/mountain_mobil.png";
import midImage from "../../assets/buddha_mobil.png";
import fgImage  from "../../assets/plants_mobil2.png";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Középső réteg */}
        <div style={wrapperStyle(midReady, "50%")}>
          <img src={midImage} alt="Middle Layer" style={layerStyle(midY)} />
        </div>

        {/* Előtér */}
        <div style={wrapperStyle(fgReady, "70%")}>
